...
> assistive capacity.
>
> Detailed information regarding permissible and restricted uses of
> AI — including the guidance addressed to autonomous coding agents
> themselves — lives in [AGENTS.md](AGENTS.md).
...
when the majority of the code is authored by a human contributor,
with AI employed exclusively for corrections or to expand on verbose
...
1. Explicitly disclose the manner in which AI was employed (in the
...
4. Not use AI to write their posts for them (bug reports, feature
   requests, PR descriptions, GitHub discussions, responses to
   reviewers).
